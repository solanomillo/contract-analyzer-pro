...
Este servicio maneja la extraccion de texto de PDF y archivos de texto,
limpieza y segmentacion. Utiliza pdfplumber como extractor principal
y pypdf como respaldo para PDFs.
"""
